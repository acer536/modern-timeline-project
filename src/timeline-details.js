...
export const eventDetails = {
  ...
  'event_1946_king_david': {
    ...
    sourceUrl: 'https://www.theguardian.com/world/2006/jul/23/israelandthepalestinians.features',
    sourceText: {
      zh: '閱讀衛報的相關報導',
  ...
  'event_1978_coastal_road': {
    ...
    sourceUrl: 'https://www.nytimes.com/1978/03/12/archives/a-sabbath-of-terror-explodes-in-israel-terror-on-the-sabbath.html',
    sourceText: {
      zh: '閱讀紐約時報的原始報導',
